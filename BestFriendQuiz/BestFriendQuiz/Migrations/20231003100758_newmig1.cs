    ...
    public partial class newmig1 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_QuestionsOfSurveys", x => x.Id);
                    table.ForeignKey(
                        name: "FK_QuestionsOfSurveys_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_QuestionsOfSurveys_Questionss_QuestionId",
                        column: x => x.QuestionId,
                        principalTable: "Questionss",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_QuestionsOfSurveys_Tests_TestId",
                        column: x => x.TestId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_QuestionsOfSurveys_QuestionId",
                table: "QuestionsOfSurveys",
                column: "QuestionId");

            migrationBuilder.CreateIndex(
                name: "IX_QuestionsOfSurveys_TestId",
                table: "QuestionsOfSurveys",
                column: "TestId");

            migrationBuilder.CreateIndex(
                name: "IX_QuestionsOfSurveys_UserId",
                table: "QuestionsOfSurveys",
                column: "UserId");
